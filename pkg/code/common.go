...
var (
	...
	ErrorLocalFSDisabled                    = NewError(incr(400), lang{zh: "服务器本地存储未开启", en: "Server local storage is not enabled"})
	ErrorInvalidImageURL                    = NewError(incr(400), lang{zh: "图片地址无效", en: "Invalid image URL"})
